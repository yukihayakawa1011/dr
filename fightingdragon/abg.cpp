...
//
//			//頂点座標の設定
//			pVtx[0].pos = D3DXVECTOR3(pos.x - SCREEN_WIDTH * 0.5f, pos.y - SCREEN_HEIGHT * 0.5f, 0.0f);
//			pVtx[1].pos = D3DXVECTOR3(pos.x + SCREEN_WIDTH * 0.5f, pos.y - SCREEN_HEIGHT * 0.5f, 0.0f);
//			pVtx[2].pos = D3DXVECTOR3(pos.x - SCREEN_WIDTH * 0.5f, pos.y + SCREEN_HEIGHT * 0.5f, 0.0f);
//			pVtx[3].pos = D3DXVECTOR3(pos.x + SCREEN_WIDTH * 0.5f, pos.y + SCREEN_HEIGHT * 0.5f, 0.0f);
//
//			//rhw(法線)の設定
//			pVtx[0].rhw = 1.0f;
//			pVtx[1].rhw = 1.0f;
